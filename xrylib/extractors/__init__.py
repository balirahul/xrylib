...
def extract_contact(fields: Dict[str, Any]) -> Contact:
    ...
    return Contact(
        ...
        last_modified=parse_datetime(_scalar(fields.get("LastModified") or fields.get("Modified") or fields.get("last_modified"))),
    )
...
def extract_call(fields: Dict[str, Any]) -> Call:
    ...
    return Call(
        ...
        number=normalise_phone(_scalar(fields.get("Number") or fields.get("number") or fields.get("PhoneNumber") or fields.get("Remote Party"))),
        name=normalise_str(_scalar(fields.get("Name") or fields.get("name") or fields.get("ContactName"))),
        timestamp=parse_datetime(_scalar(fields.get("Time") or fields.get("Date") or fields.get("Timestamp") or fields.get("timestamp"))),
        duration=duration,
...
def extract_message(fields: Dict[str, Any]) -> Message:
    ...
    return Message(
        ...
        item_id=fields.get("_id"),
        direction=parse_direction(_scalar(fields.get("Direction") or fields.get("direction") or fields.get("Type"))),
        sender=normalise_phone(_scalar(fields.get("From") or fields.get("Sender") or fields.get("sender") or fields.get("Remote Party"))),
        ...
        service_center=normalise_phone(_scalar(fields.get("ServiceCenter") or fields.get("service_center") or fields.get("SMSC"))),
    )
...
def extract_media_file(fields: Dict[str, Any]) -> MediaFile:
    ...
    return MediaFile(
        ...
        taken=parse_datetime(_scalar(fields.get("Taken") or fields.get("DateTaken") or fields.get("ExifDate") or fields.get("DateTime"))),
...
def extract_installed_app(fields: Dict[str, Any]) -> InstalledApp:
    ...
    return InstalledApp(
        ...
        package_name=normalise_str(_scalar(fields.get("PackageName") or fields.get("BundleID") or fields.get("package_name") or fields.get("Identifier"))),
        ...
        install_date=parse_datetime(_scalar(fields.get("InstallDate") or fields.get("Installed") or fields.get("install_date"))),
...
def extract_calendar_event(fields: Dict[str, Any]) -> CalendarEvent:
    ...
    return CalendarEvent(
        ...
        start=parse_datetime(_scalar(fields.get("Start") or fields.get("StartDate") or fields.get("StartTime") or fields.get("Begin"))),
...
def extract_wireless_network(fields: Dict[str, Any]) -> WirelessNetwork:
    return WirelessNetwork(
        ...
        source=fields.get("_source"),
        item_id=fields.get("_id"),
        ssid=normalise_str(_scalar(fields.get("SSID") or fields.get("ssid") or fields.get("Name") or fields.get("NetworkName"))),
        bssid=normalise_str(_scalar(fields.get("BSSID") or fields.get("bssid") or fields.get("MAC") or fields.get("AccessPoint"))),
        ...
        first_connected=parse_datetime(_scalar(fields.get("FirstConnected") or fields.get("FirstSeen") or fields.get("Created"))),
...
def extract_user_account(fields: Dict[str, Any]) -> UserAccount:
    return UserAccount(
        ...
        source=fields.get("_source"),
        item_id=fields.get("_id"),
        account_type=normalise_str(_scalar(fields.get("AccountType") or fields.get("Type") or fields.get("Service") or fields.get("_type"))),
